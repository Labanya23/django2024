...
class Volunteer(models.Model):
    ...
    idpic=models.ImageField(upload_to='voluteer',null=True,blank=True)
...
class DonationArea(models.Model):
    ...
    creationdodate=models.DateTimeField(auto_now_add=True)
    def __str__(self):
...
class Donation(models.Model):
    ...
    doantaionpic = models.ImageField(upload_to='donation',null=True,blank=True)
    collectionloc=models.CharField(max_length=300,null=True)
    description=models.CharField(max_length=300,null=True)
    status=models.CharField(max_length=30,null=True)
    donatiodate=models.DateField(null=True)
